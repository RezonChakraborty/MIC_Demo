...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: 'oda-ea7ee6ca09024e5fa0656e7ca7c8dee3-da2.data.digitalassistant.oci.oraclecloud.com',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: '9b75a8b6-ce8a-4f6d-a1e0-28363d44df24',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
        ...
        i18n: {                                     // Provide translations for the strings used in the widget
            en: {                                   // en locale, can be configured for any locale
                chatTitle: 'MIC'       // Set title at chat header
            }
        },
